        ...
        >
          <Link href="/products">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group relative px-8 py-4 bg-black text-white rounded-lg font-medium text-sm uppercase tracking-wider overflow-hidden transition-colors hover:bg-gray-900"
            >
          ...
          <Link href="/products/lumina-iq">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 border-2 border-gray-900 text-gray-900 rounded-lg font-medium text-sm uppercase tracking-wider transition-all"
            >
